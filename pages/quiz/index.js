...
export default function About() {
    ...
    const [answer, setanswerValidaty] = useState(false)
    ...
    return (
        <>
            {showResult ? <Result score={score} totalScore={questions.length} states= {[setanswerState,setCounter,setScore,setProgress,setwrongAnswers,setanswerValidaty,setShowResult]}/> : 
            <div className="container desktop:w-3/6 container-md mx-auto d-flex justify-center p-2">
                <div className='w-100'>
                    <header>
                        <Progress progress={progress/questions.length*10} />
                        <h2 className='text-dark-900 text-4xl text-center'>Quiz App</h2>
                    </header>
                    <main className='p-4'>
                        <div>
                        ...
                        <div>
                            <ul className="flex">
                                <Rating difficulty={questions[counter].difficulty} />
                            </ul>
                        </div>
                        <div className='py-15'>
                            <div>
                        ...
                        <div className='py-6'>
                            <div className='flex justify-between'>
                                <p>Score: {score/questions.length*10}%</p>
                                <p>Max Score: {100-((wrongAnswers*10)/questions.length*10)}%</p>
                            </div>
                            <div className='rounded relative bg-black'>
                                <BottomProgress score={score} totalScore={questions.length} wrongAnswers={wrongAnswers} />
                            </div>
                        </div>
                    </main>
                </div>
